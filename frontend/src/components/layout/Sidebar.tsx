      ...
      <div className="relative px-5 py-5 border-b border-[var(--border-default)]">
        <Link href="/" className="flex items-center gap-2.5 group">
          <motion.div
            ...
            className="relative w-8 h-8 rounded-lg bg-gradient-to-br from-[var(--accent-blue)] to-[var(--accent-purple)] flex items-center justify-center shadow-[0_0_18px_var(--glow-blue)] group-hover:shadow-[0_0_28px_var(--glow-purple)] transition-shadow duration-300 shrink-0"
          >
